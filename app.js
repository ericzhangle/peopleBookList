...
var url="mongodb://tom:123@127.0.0.1:27017/test";
var people=require("./schemas");
mongoose.connect(url);
console.log("zhangle");
mongoose.connection.on("connected",function(){console.log("db connected")});
...
//var app = require('../app');
var debug = require('debug')('zhangletest:server');
